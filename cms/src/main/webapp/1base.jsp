...
<body>
	...
	<div class="container">
		<a href="userlogout.jsp" class="logout-btn">Logout</a>
		<div class="left">
			<div class="logo">
				<!-- <img src="resource/Images/klu/logo1.svg" alt="Profile Image"
					className="profileimage" srcset=""> -->

				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
					width="290" height="22" color="white" fill="none">
                    <path d="M4 5L14 5" stroke="currentColor"
			...
			<div class="menu">
				<div class="option">
					<div class="icon">
						<a href="studenthome.jsp" class="option-anchor"> <svg
				...
				<div class="option">
					<div class="icon">
						<a href="courseSelection.jsp" class="option-anchor"> <svg
								xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
								width="24" height="24" color="#000000" fill="none">
                            <path
                            ...
                            <path
									...
									stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                            <path d="M15 9.5L19 9.5"
									stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                            <path d="M15 13.5H17" stroke="currentColor"
									stroke-width="1.5" stroke-linecap="round" />
                        </svg>
							<div class="hometext">My courses</div></a>

					</div>
				</div>
				<div class="option">
					<div class="icon">
						<a href="viewAssignment.jsp" class="option-anchor"> <svg
								xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
								width="24" height="24" color="#000000" fill="none">
                            <path
                            ...
                            <path
									...
									stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                            <path
									d="M19.5 18L18.9142 18.5541C18.2475 19.1847 17.9142 19.5 17.5 19.5M15.5 18L16.0858 18.5541C16.7525 19.1847 17.0858 19.5 17.5 19.5M17.5 19.5V15.5"
									stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
									stroke-linejoin="round" />
                            <path
							...
							<div class="hometext">Assignment</div></a>
				...
				<div class="option">
					<div class="icon">
						...
						<a href = "viewStudentTita.jsp" class="option-anchor">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
							width="24" height="24" color="#000000" fill="none">
...
<a href = "studentViewForum.jsp" class="option-anchor">
				...
				<div class="option">
					<div class="icon">
						...
						<div class="hometext">Settings</div>
 ...
 if (pk != null) {
 	String username = (String) pk.getAttribute("username");
 	if (username != null) {
 		out.print(username);
 	} else {
 		out.print("Guest");
...
/*  String username=null;
 HttpSession session1 = request.getSession();  // Creates a new session if one doesn't exist
